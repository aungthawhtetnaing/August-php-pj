...
<body>
  <div class="page">
                    <h1 class="title"><i class="fa fa-truck" style="color:black">&nbsp;</i>Add Delivery Staff</h1><br>                          
<div class="container" >
  <div class="row" >
...
<form method="post" class="form-horizontal" >
        ...
        <label class="col-sm-5" ><i class="fa fa-user" style="font-size:20px;color: black"> &nbsp;Delivery Staff Name</i></label>
        <div class="col-sm-12">
