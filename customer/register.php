...
<form method="post" class="form-horizontal" >
        ...
        <label class="col-sm-4" id="letter" ><i class="fa fa-user"  style="font-size: 20px;"></i> &nbsp;User Name</label>
        <div class="col-sm-12">
...
<div class="form-group row">
<label class="col-sm-3" id="letter"><i class="fa fa-address-book"> &nbsp;Address</i></label>
<div class="col-sm-12">
...
<br>
  <div class="end">Have an account?<a href="login.php" style="text-decoration: none; color: #3897f0"> Log in</a> </div>
</div>
</div>
