          ...
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              ...
              <p class="address mb-5" >
                <em>
                  <strong><span class="fa fa-home"></span>&nbsp;Building(1), Room(12), Insein Road, Near Hledan</strong><br>
                  <strong><span class="fa fa-home"></span> No-121(A), Phone Gyi Street, Lanmadaw Tsp.</strong><br>
                   <strong><span class="fa fa-home"></span>&nbsp;No-270, Pyay Road, Sanchaund Tsp.</strong>
              </p>
              ...
              <p class="mb-0">
                ...
                <br>
               <span class="fa fa-phone"></span>(+95)09966077888
              </p>
              <br>
              <p>
                <i class="fa fa-facebook-square" style="font-size:24px;color: #1778F2"></i>&nbsp;
                <a href="https://www.facebook.com/august.yangon.myanmar" style="color: black;"> August Drinks & Fried Chicken</a>
              </p>
            </div>
          </div>
        </div>
