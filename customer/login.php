...
if(isset($_POST['login']))
	{
		...
		{
			$db_user_name=$out['customer_name']	;	
...
<div class="page">
    <div class="container">
        <div class="left">
            <div class="login"><img src="photo/august.jpg" width=" 310px;"   ></div>
             <div class="eula">Don't have an account?<a href="register.php" style="text-decoration: none; color: #3897f0"> Sign up</a> </div>
        </div>
        <div class="right">
            ...
            <form action="" method="post" class="form-inline">	
              <div class="form">
                ...
                <input type="text" id="email" required  id="username" name="username">
